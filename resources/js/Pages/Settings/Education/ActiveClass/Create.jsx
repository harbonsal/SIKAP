...
export default function Create({ academicYears, kelas, kelasParalels, teachers, defaultAcademicYearId }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('active-classes.store'));
    };

    return (
        <MainLayout>
            <Head title="Tambah Kelas Aktif" />
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight text-foreground">Tambah Kelas Aktif</h2>
                        <p className="text-muted-foreground">Buat rombongan belajar baru.</p>
                    </div>
                </div>
