...
export default function Edit({ jenjang, staffUsers }) {
    const { data, setData, put, processing, errors } = useForm({
        name: jenjang.name,
        nama_arab: jenjang.nama_arab || '',
        description: jenjang.description || '',
        headmaster_user_id: jenjang.headmaster_user_id || '',
        headmaster_title: jenjang.headmaster_title || '',
    });
        ...
        <MainLayout>
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight text-foreground">Edit Jenjang</h2>
                        <p className="text-muted-foreground">Perbarui informasi jenjang pendidikan.</p>
                    </div>
                </div>
