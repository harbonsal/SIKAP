...
export default function Edit({ mapel }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('mapels.update', mapel.id));
    };
        ...
        <MainLayout>
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight text-foreground">Edit Mata Pelajaran</h2>
                        <p className="text-muted-foreground">Perbarui informasi mata pelajaran.</p>
                    </div>
                </div>
