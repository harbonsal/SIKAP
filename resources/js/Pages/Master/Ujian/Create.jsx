...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('ujians.store'));
    };

    return (
        <MainLayout>
            <Head title="Tambah Jenis Ujian" />
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight text-foreground">Tambah Jenis Ujian</h2>
                        <p className="text-muted-foreground">Tambahkan jenis ujian baru dan tentukan semesternya.</p>
                    </div>
                </div>
