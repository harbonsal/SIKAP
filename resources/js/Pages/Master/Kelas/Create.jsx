...
export default function Create({ jenjangs }) {
        ...
        <MainLayout>
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight text-foreground">Tambah Kelas</h2>
                        <p className="text-muted-foreground">Tambahkan kelas baru dan hubungkan dengan jenjang.</p>
                    </div>
                </div>
