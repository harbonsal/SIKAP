...
patch_dir = r'f:\MASTER PROGRAM\SIKAP\temp_patch_clear_fix'
...
zip_path = r'f:\MASTER PROGRAM\SIKAP\patch_clear_fix.zip'
...
shutil.rmtree(patch_dir)
print('Smart zip patch_clear_fix.zip successfully created.')
