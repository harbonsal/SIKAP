import{r as i,j as a,H as c}from"./app-BRzUhs_B.js";function t({student:e,schoolInfo:s,signer:l}){return i.useEffect(()=>{window.print()},[]),a.jsxs(a.Fragment,{children:[a.jsx(c,{title:`Biodata - ${e.user.name}`}),a.jsxs("div",{className:"print-container text-sm leading-relaxed",children:[a.jsx("style",{children:`
                    @page {
                        size: A4;
