...
patch_dir = r'f:\MASTER PROGRAM\SIKAP\temp_patch_gabungan'
...
zip_path = r'f:\MASTER PROGRAM\SIKAP\patch_gabungan_ui.zip'
...
shutil.rmtree(patch_dir)
print('Smart zip patch_gabungan_ui.zip successfully created.')
