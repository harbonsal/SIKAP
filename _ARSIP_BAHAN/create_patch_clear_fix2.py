...
patch_dir = r'f:\MASTER PROGRAM\SIKAP\temp_patch_clear_fix2'
...
zip_path = r'f:\MASTER PROGRAM\SIKAP\patch_clear_fix2.zip'
...
shutil.rmtree(patch_dir)
print('Smart zip patch_clear_fix2.zip successfully created.')
